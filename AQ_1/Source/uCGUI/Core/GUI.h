...
//#define GUI_beijing       0x292929   
#define GUI_BROWN         0x2A2AA5

#define GUI_beijing       0x081122
...
extern GUI_CONST_STORAGE GUI_FONT GUI_Font48ASCII;
/* Comic fonts */
...
void GUI_DispCEOL_leftline(void) ;
void GUI_DispCEOL_rightline(void) ;
void GUI_DispCEOL_confirm_num(void);
